...
export default class DialogBottom extends Component {
    mixins = [TimerMixin];
    parent ={};
                ...
                <View style={styles.container} >
                    ...
                    <Animated.View style={[styles.tip , {transform: [{
                        translateY: this.state.offset.interpolate({
                            inputRange: [0, 1],
                            outputRange: [height-aHeight+30, (height-aHeight -34)]
                        }),
                    }]
                    }]}>
    ...
    choose(msg) {
        ...
        if(!this.state.hide){
            this.out();
            this.parent.saveToCamra();
        }
    }

    show(title: string, choose1:string,obj:Object) {
        this.parent = obj;
        if(this.state.hide){
            console.log('------');
            console.log(this.state.hide);
            this.setState({title: title, choose1: choose1, hide: !this.state.hide}, ()=>{this.in;console.log(this.state.hide);});
